...
function MovieSearchCard({ movie, isProfile, addLike, removeLike, deleteMovie, loggedUser }) {
    ...
    return (
        ...
        <Image src={movieInfo.poster_path} wrapped ui={false} />
        <Card.Content>
            <Card.Description>{movieInfo.title}</Card.Description>
        </Card.Content>
